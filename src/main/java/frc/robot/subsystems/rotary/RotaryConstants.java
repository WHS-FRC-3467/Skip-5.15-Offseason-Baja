...
public class RotaryConstants {
    ...
    public static TalonFXConfiguration getFXConfig()
    {
        ...
        config.Feedback.FeedbackRemoteSensorID = Ports.ARM_CANCODER.id();
        ...
        switch (Constants.currentMode) {
            case REAL:
                return new Rotary(new RotaryMechanismReal(
                    new MotorIOTalonFX(NAME, getFXConfig(), Ports.ARM_MAIN),
                    CONSTANTS,
                    Optional.of(new AbsoluteEncoderIOCANCoderSim(Ports.ARM_CANCODER,
